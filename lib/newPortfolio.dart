...
class NewPortfolio extends StatefulWidget{
  @override
  _NewPortfolio createState() => _NewPortfolio();
}

class _NewPortfolio extends State<NewPortfolio> {
                  ...
                  child:Padding(
                    ...
                    child: Row(
                      ...
                      children:<Widget>[
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("New Portfolio WebApp",
                            style:TextStyle(
                              fontSize: 20.0,
                              color:Colors.lightBlue[900],),
                          ),
                      ...
                      children: [
                        Container(decoration: new BoxDecoration(
                          shape: BoxShape.rectangle,
                            ...
                            child: Image(image:AssetImage('assets/images/new_portfolio.PNG'),width: 290,height: 180,)),
                      ],
                    ),
                  ),
                  SizedBox(height: 50,),
